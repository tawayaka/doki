...
RUN apt-get update --fix-missing \
	...
	&& wget --no-check-certificate https://github.com/ant-media/Ant-Media-Server/releases/download/ams-v2.4.3/ant-media-server-community-2.4.3.zip -O /tmp/ant.zip \
...
RUN chmod 777 /usr/local/antmedia
EXPOSE 5080
